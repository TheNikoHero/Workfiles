...
function Upload($FILES, $hvilken_mappe_skal_filen_gemmes_i) {
    ...
    //and we're checking....
    if ($error != 0) { //if NOT 0 (means, there is 0 errors) then something is wrong
        die("der er sket en fejl");
    }
    if (!in_array($type, $allowed_filetypes)) {
        echo "The file we get is:";
        echo "<br>";
        echo "Name: $name";
        echo "<br>";
        echo "Type: $type";
        ...
        echo "Size: $size";
        echo "<br>";
        die("The filetype is not allowed! Your filetype: $type");
